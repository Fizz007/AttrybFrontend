...
function Signup(){
    ...
    const handleSubmit = async(e)=>{
        ...
        e.preventDefault();
        try {
            let res = await axios.post(`${baseurl}/user/signup` , obj);
    ...
    <ColorModeProvider>
    <Flex minHeight='100vh' bg='#202A44' width='full' align='center' justifyContent='center'>
    <Box 
      px={4}
      width='full'
      maxWidth='500px'
    ...
    >
      ...
      <Box textAlign='center'>
        <Image borderRadius='50%'  maxW='100px' m='auto' mb='20px' src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSWkdBb3OhntG6WeZl2HAjoehZf5iKB2_KWjg&usqp=CAU' />
